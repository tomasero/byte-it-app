////
////  GRUSController.swift
////  ByteItApp
////
////  Created by Tomás Vega on 7/18/19.
...
////import CoreMotion
//
//class GRUSController: UIViewController,
//    CBCentralManagerDelegate,
//CBPeripheralDelegate {
//    
//    var manager:CBCentralManager!
////    var _peripheral:CBPeripheral!
//    var _peripherals:[CBPeripheral?] = [nil, nil]
...
//    
//    func getPeripheralState(tag: Int) -> String {
//        var states: [String] = []
//        for _peripheral in _peripherals {
...
////    }
//
//    func disconnect(tag: Int) {
//        if manager != nil {
//            if let peripheral = _peripherals[tag] {
//                manager.cancelPeripheralConnection(peripheral)
//            }
//        }
//    }
...
////            var connected = 0
////            for (i, _peripheral) in _peripherals.enumerated() {
////                print("en el loop")
////                print(_peripheral)
////                if _peripheral == nil {
////                    print("== nil")
////                    _peripherals[i] = peripheral
////                    _peripherals[i]!.delegate = self
...
//            var connected = 0
//            if self.tag != -1 {
//                _peripherals[self.tag] = peripheral
//                _peripherals[self.tag]!.delegate = self
//                manager.connect(peripheral, options: nil)
//                self.manager.stopScan()
//            }
//            debugPrint("Found Bean.")
...
//                print(peripheral.identifier)
//                for _pperipheral in _peripherals {
//                    if let _peripheral = _pperipheral {
//                        if _peripheral.identifier == peripheral.identifier {
//                            _peripheral.setNotifyValue(true, for: thisCharacteristic)
//                        }
//                    }
//                }
